...
final class pkg_organizationsInstallerScript
{
    private const MINIMUM_CORE = '1.4.0';
    ...
    public function preflight($type, $parent): bool
    {
        ...
        Factory::getApplication()->enqueueMessage('Organizations requires Core ' . self::MINIMUM_CORE . ' or later.', 'error');
        return false;
    }
    ...
    public function postflight($type, $parent): void
    {
        ...
        try {
            ...
            $canonicalId = $this->packageId($db, 'pkg_organizations');
            $legacyId = $this->packageId($db, 'pkg_xdecaroorganizations');
            ...
            $componentElement = 'com_xdecaroorganizations';
            ...
            if ($package_id !== $canonicalId) {
                Factory::getApplication()->enqueueMessage(
                    'Organizations package identity migration was not completed because child ownership could not be verified.',
                    'warning'
                );
                return;
            }
            ...
            if (defined('JPATH_MANIFESTS')) {
                $legacyManifest = JPATH_MANIFESTS . '/packages/pkg_xdecaroorganizations.xml';
            ...
            Factory::getApplication()->enqueueMessage(
                'Organizations package identity migration needs attention: ' . $exception->getMessage(),
                'warning'
            );
        }
    }
