...
$checks = [
    ...
    [$model, "quoteName('af.organization_id')", 'Affiliation count must include outgoing relations only.'],
    [$model, 'affiliate_count', 'Organizations list must expose a separate incoming affiliates count.'],
    [$model, "quoteName('afi.target_organization_id')", 'Affiliate count must use incoming relations.'],
    ...
    [$it, 'COM_XDECAROORGANIZATIONS_COLUMN_AFFILIATES="Affiliati"', 'Italian affiliates column label is required.'],
