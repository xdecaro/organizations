...
if (!$usesItemName || !$escapesName || !$usesNewFallback || !$headingBeforeTabs) {
    fwrite(STDERR, "Organization edit page must show the current organization name above the tabs, with a safe fallback for new records.\n");
    exit(1);
}
