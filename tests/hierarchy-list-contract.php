...
if (!$behaviorOk || !$modelUsesHierarchy || !$templateShowsHierarchy || !$cssIndentsByDepth) {
    fwrite(STDERR, "Organizations list must order records as a parent/child tree, preserve cyclic/orphan records safely, paginate after tree ordering, and visibly indent each name by hierarchy depth.\n");
    exit(1);
}
