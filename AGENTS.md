...
Version 0.1.0 establishes the first technical baseline. Keep stable IDs `com_decaroorganizations` and `pkg_decaroorganizations`. Normal updates must preserve data and configuration. ZIPs must be directly installable in Joomla.
